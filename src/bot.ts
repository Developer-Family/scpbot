...
bot.on("debug", (message) => logger.debug(message));
...
logger.log("debug", `Token : ${BOT_TOKEN}`);
...
bot.on("message", (message) => {
  ...
  if (message.content === PREFIX + "help") {
    const help_embed = new RichEmbed()
      ...
      .addField(
        ...
        "Pour avoir les fiches d'informations des SCP **__tapez__**: =info lenuméroduscp \n Pour voir les images des SCP **__tapez__**: =show lenuméroduscp"
      )
      .addField(
        "__Autres commandes__:",
        "**__=don__**: Pour soutenir le Bot et le maintenir en vie !"
      )
      .addField(
        "__SCP Safe__:",
        "-SCP-914 \n -SCP-343 \n -SCP-1025 \n -SCP-1074 \n -SCP-1123 \n "
  ...
  if (message.content === PREFIX + "don") {
    const don_embed = new RichEmbed()
      .setColor("RANDOM")
      .addField(
        "__**Pour faire un don ça ce passe ici**__:",
        "Ce bot tourne sur un serveur payé par l'auteur, vous pouvez aider à son bon fonctionnement en allant sur [uTip](https://utip.io/tazwind) pour regarder une pub ou me faire un don.",
        true
      )
      .setFooter("Le BOT est en développement !");
  ...
  if (message.content === PREFIX + "info 527") {
    const scp_527 = new RichEmbed()
      ...
      .addField(
        ...
        "SCP-527 doit être contenu dans un domicile pour humanoïde standard au Site-19. Aucune autre procédure de confinement n'est nécessaire."
      )
      .addField(
        "**Description**:",
      ...
      .addField(
        "**Découverte**:",
        "SCP-527 a été découvert à Boston par des agents de la Fondation et a été déplacé au Site-19 en 2004."
      )
      .addField(
        "Le Wiki",
        "Voir la page wiki complète: \n [SCP-527](http://fondationscp.wikidot.com/scp-527)",
        true
      );
  ...
  if (message.content === PREFIX + "info 914") {
    const scp_914 = new RichEmbed()
      ...
      .addField(
        "**AVERTISSEMENT**:",
        'Actuellement, aucun essai avec de la matière biologique n\'est autorisé. Se référer au document 109-B:117. Appliquer le réglage "Grossier" sur de la matière explosive est déconseillé.'
      )
      .addField(
        "**Description**:",
      ...
      .addField(
        "**Description**:(2)",
        'Entre les deux se trouve un panneau en cuivre doté d\'une poignée avec une petite flèche attachée dessus. Les mots Très Grossier, Grossier, 1:1, Fin et Très Fin sont positionnés en des points autour de la poignée. Sous la poignée se trouve une grande "clé" qui déclenche le "ressort principal".'
      )
      .addField(
        "**Description**:(3)",
  ...
  if (message.content === PREFIX + "info 106") {
    const scp_106 = new RichEmbed()
      ...
      .addField(
        "**Procédures de Confinement Spéciales**(2):",
      ...
      .addField(
        "**Procédures de Confinement Spéciales**(3):",
      ...
      .addField(
        "**Procédures de Confinement Spéciales**(4):",
  ...
  if (message.content === PREFIX + "info 006-fr") {
    const scp_006fr = new RichEmbed()
      ...
      .addField(
        "**Description**:(8)",
        "Toutes les tentatives d'entrer dans la réserve pendant que SCP-006-FR était en état actif se sont soldées par un échec, et ont déclenché la colère de l'entité qui a tué tous les membres du personnel alors présents dans SCP-006-01-FR : voir Incident 01-006."
      )
      .addField(
        "Le Wiki",
  ...
  if (message.content === PREFIX + "info 011-fr") {
    const scp_011fr = new RichEmbed()
      ...
      .addField(
        "Le Wiki",
        "Voir la page wiki complète: \n [SCP-011](http://fondationscp.wikidot.com/scp-011-fr)",
        true
      );
  ...
  if (message.content === PREFIX + "info 060-fr") {
    const scp_060fr = new RichEmbed()
      ...
      .addField(
        "**Procédures de Confinement Spéciales**:",
        "SCP-060-FR doit être confiné dans une cellule pour humanoïde standard de l'Unité de Confinement-04 du Secteur-E8 de la Zone Armée de Recherche et de Confinement-Avanaa. La cellule ne doit posséder ni fenêtre, ni conduit de ventilation, et doit être scellée hermétiquement. De plus, celle-ci doit être éclairée en permanence et sa température doit être maintenue au-dessus de vingt-cinq (25) degrés Celsius. Le seul accès à la cellule doit être fermé à l'aide d'une porte en acier blindé dont la face intérieure doit être recouverte d'une plaque d'électrum1 de cinq (5) centimètres d'épaisseur."
      )
      .addField(
        "**Procédures de Confinement Spéciales**:(2)",
        "Un minimum de deux (2) gardes armés de lance-flammes M2 doit être présent en permanence à proximité de la cellule de SCP-060-FR. Toutes les instances de SCP-060-FR-1 et -2 doivent être immédiatement détruites par le feu et leurs restes doivent être jetés dans l'incinérateur prévu à cet effet.En aucun cas, les restes d’un être vivant doivent se trouver à moins de vingt (20) mètres de l’entité.2"
      )
      .addField(
        "**Procédures de Confinement Spéciales**:(3)",
        "Suite à l'Incident 060-EV-01, un sas de quinze (15) mètres de long doit être aménagé à l'entrée de la cellule de SCP-060-FR dans le but de diminuer les risques de brèches de confinement. Une (1) unité de combat robotisée de classe Dragon doit être présente en permanence à l'intérieur du sas. Celle-ci doit subir une maintenance toutes les semaines et être remplacée si nécessaire.Un microphone relié au Poste de garde-E8-04 doit être installé à l'intérieur de la cellule."
      )
      .addField(
        "**Description**:",
        "SCP-060-FR est une entité humanoïde de 1,75 mètre portant une grande bure noire fabriquée dans un tissu inconnu à consistance brumeuse. Il est actuellement impossible de distinguer son visage à cause de la présence permanente d'un voile noir à son emplacement. L'entité porte des gantelets et des bottes fabriqués dans un métal inconnu.Les tests initiaux3 effectués après sa capture ont permis de déterminer que SCP-060-FR possède bien un corps physique bien que celui-ci ne présente aucun signe vital."
      )
      .addField(
        "**Description**:(2)",
        "SCP-060-FR possède la capacité de faire varier la température de l'air de zéro (0) à -2██ degrés Celsius à volonté dans un rayon de cinq (5) mètres autour de lui.Il a aussi été observé que SCP-060-FR possède la capacité de se faufiler dans tous les types d'ouvertures peu importe leur taille ou leur forme. \n À noter que son contrôle sur ces deux capacités est fortement diminué lorsque la température ambiante dépasse vingt-cinq (25) degrés Celsius."
      )
      .addField(
        "**Description**:(3)",
        "SCP-060-FR est fortement affecté négativement par l'or et l'argent et ne peut pas s'approcher à moins de ██ mètres de tout ce qui contient entre ██ et ██ pourcents de ces deux métaux sans [DONNÉES SUPPRIMÉES]."
      )
      .addField(
        "**Description**:(4)",
        "La principale capacité anormale de l'entité se manifeste lorsque les restes d'un être vivant4 se trouvent à moins de vingt (20) mètres de celle-ci. Lorsque cela se produit, SCP-060-FR envoie cinq (5) chaînettes se planter dans les membres et la tête du corps. Les restes sont alors désignés SCP-060-FR-1. Une fois les chaînettes implantées, SCP-060-FR est en mesure de contrôler l'instance de SCP-060-FR-1 comme un pantin jusqu'à ce que celle-ci soit totalement détruite. Le nombre maximum de corps que l'entité peut contrôler simultanément est actuellement inconnu. À noter que les instances de SCP-060-FR-1 réagissent de la même façon que l'entité lorsqu'elles sont exposées à de l'or ou à de l'argent."
      )
      .addField(
        "**Description**:(5)",
        "Le meilleur moyen de repousser SCP-060-FR et de détruire les instances de SCP-060-FR-1 est le feu. Lorsque n'importe quels autres types de dommages leur sont infligés, les instances de SCP-060-FR-1 vont [DONNÉES SUPPRIMÉES]."
      )
      .addField(
        "Le Wiki",
  ...
  if (message.content === PREFIX + "info bright") {
    const dr_bright = new RichEmbed()
      .setColor("RANDOM")
      .addField("**Objet#**:", "Dr Bright")
      .addField("**Classe**:", "Apollyon")
      .addField(
        "**Description**:",
        "Le PIRRRRRRRRE membre de la Fondation SCP !"
      )
      .addField(
        "La liste de ce qu'il est interdit de faire:",
        "[La liste](http://fondationscp.wikidot.com/the-things-dr-bright-is-not-allowed-to-do-at-the-foundation)",
        true
      )
      .setFooter(
        'La devise de la Fondation est "Sécuriser, Contenir, Protéger", et non pas l\'une des choses suivantes:  \n "Sucer Couilles et Pénis"'
      );
    message.channel.sendEmbed(dr_bright);
    console.log("Commande Dr Bright faite");
  }
  if (message.content === PREFIX + "info 137-fr") {
    const scp_137fr = new RichEmbed()
      .setColor("RANDOM")
      .addField("**Objet#**:", "SCP-137-FR")
      .addField("**Niveau de Menace**:", "Jaune")
      .addField(
        "**Procédures de Confinement Spéciales**:",
        "SCP-137-FR doit être conservé dans un coffre sécurisé au Site-Aleph et n'en être sorti qu'à l'occasion de tests sur des membres du personnel de Classe D. En dehors des tests, seuls des membres du personnel étant confirmés comme dépourvus de croyance religieuse sont autorisés à manipuler SCP-137-FR, afin de prévenir toute ouverture accidentelle."
      )
      .addField(
        "**Description**:",
        'SCP-137-FR est une brochure en papier glacé, mesurant 15 x 25 cm et pliée en deux. Sur le recto de SCP-137-FR est imprimée la phrase "Un monde sans religion, est-ce possible ?" accompagnée de l\'image de la Terre entourée de divers symboles religieux. Le verso est simplement marqué du mot "Oui." avec au bas le logo d\'une organisation nommée "SAPHIR", jusqu\'ici inconnue et non-recensée (voir le Journal de Récupération). \n Les deux volets internes sont vierges.'
      )
      .addField(
        "**Description**:(2)",
      ...
      .addField(
        "Le Wiki",
        "Voir la pasge wiki complète: \n [SCP-137-FR](http://fondationscp.wikidot.com/scp-137-fr)",
        true
      );
  ...
  if (message.content === PREFIX + "info 343") {
    const scp_343 = new RichEmbed()
      ...
      .addField(
        "Le Wiki",
        " Voir la page complète: \n [SCP-343](http://fondationscp.wikidot.com/scp-343)",
        true
      );
  ...
  if (message.content === PREFIX + "info 1074") {
    const scp_1074_1 = new RichEmbed()
      .setColor("RANDOM")
      .setThumbnail(
      ...
      .addField(
        "**Procédures de Confinement Spéciales**:(4)",
        "Ce processus devra être répété aussi longtemps que la progression des effets de SCP-1074 le permette."
      )
      .addField(
        "**Description**:",
        "SCP-1074 est une peinture sur toile, produite par un artiste non identifié. Lorsqu'elle est photographiée ou filmée, SCP-1074 semble ne représenter qu'un gris uniforme, avec des mouvements de pinceaux visibles."
      )
      .addField(
        "**Description**:(2)",
        "Les échantillons de SCP-1074 retirés par robot télécommandé ont été identifiés comme de la peinture à l'huile grise d'un type fréquemment disponible dans de nombreux magasins des Etats-Unis."
      )
      .addField(
        "**Description**:(3)",
        "Lorsque SCP-1074 est observé par un être humain, l'observateur montre dès le début des symptômes physiologiques similaires au syndrome de Stendhal1, comme une accélération du rythme cardiaque, des sueurs, et des vertiges."
      )
      .addField(
        "**Description**:(4)",
        "L'individu qui observe SCP-1074 tentera alors de décrire l'œuvre observée dans les plus grands détails aux personnes qui l'entourent, la décrivant fréquemment comme la plus belle ou la plus touchante œuvre qu'ils n'aient jamais vu. Les personnes fortement affectées par l'œuvre ne la décriront pas comme entièrement grise, mais comme une peinture très détaillée de nature inconsistante."
      )
      .addField(
        "**Description**:(5)",
        "La scène peinte n'est jamais la même pour deux personnes différentes; les thèmes récurrents, d'après les personnes observant SCP-1074, sont des scènes décrivant les aspects de la mortalité humaine, l'insignifiance individuelle, le jugement légal ou moral, l'eschatologie religieuse, ou [DONNÉES CENSURÉES]."
      )
      .addField(
        "**Description**:(6)",
        "Lors de l'observation de SCP-1074, l'observateur ne cessera pas de regarder l'œuvre à moins d'en être contraint par la force, et il tentera de convaincre toutes les personnes présentes de regarder l'œuvre également."
      )
      .addField(
        "**Description**:(7)",
      ...
      .addField(
        ...
        "[LA SUITE](http://fondationscp.wikidot.com/scp-1074)",
        true
      );
  ...
  if (message.content === PREFIX + "info 1123") {
    const scp_1123 = new RichEmbed()
      ...
      .addField(
        "**Procédures de Confinement Spéciales**:(suite)",
        "SCP-1123 devrait seulement être transporté dans son conteneur et ne devra pas être manipulé sauf pendant une expérience contrôlée. Quand il n'est pas en test, il sera stocké dans un casier contrôlé par climat sûr au Site 19."
      )
      .addField(
        "**Description**:",
        'SCP-1123 est un crâne humain duquel il manque la mandibule inférieure et toutes ses dents. À travers le squama frontalis extérieur est l\'écriture khmer moderne, écrit en sang humain, qui se traduit comme "Se souviennent". Tant le crâne que le sang ont été définitivement datés à 197█ et le dépistage génétique confirme que tous les deux sont du même individu.'
      )
      .addField(
        "**Description**:(2)",
      ...
      .addField(
        "**Description**:(3)",
        "L'écrit khmer est mal effacé et invisible à la plupart des sujets au-delà d'une distance de 5 mètres. Cependant, quand un sujet s'approche de SCP-1123 il rapportera que l'écrit devient progressivement plus visible jusqu'à moins de 1 mètre, il le rapportera apparaissant comme récemment dessiné."
      )
      .addField(
        "**Description**:(4)",
        "Quelques sujets à cette distance rapportent que l'écriture est \"toujours humide.\" Cet effet n'est pas reproductible avec l'équipement optique. Enregistrer l'écrit exige photographiquement l'amélioration optique ou l'éclairage UV. (Le dernier n'est pas approuvé pour l'utilisation avec SCP-1123 comme il contribue à la dégradation de l'objet)."
      )
      .addField(
        "**Description**:(5)",
        "Les sujets à cette distance rapporteront souvent aussi d'autres phénomènes sensoriels anormaux, y compris des odeurs (comme la viande cuisinée ou des cendres), des sons (comme un cri doux, des battements de cœur faibles ou la respiration, ou des pas éloignés) et des réponses tactiles"
      )
      .addField(
        "Note",
        "(comme le sable dans les yeux, des fourmis rampant à l'arrière de la main, ou des éclats de verre dans la plante du pied.)"
      )
      .addField(
        "**Description**:(6)",
      ...
      .addField(
        "**Description**:(7)",
        "La fugue est caractérisée par la confusion, la désorientation et l'adoption d'une nouvelle identité et des souvenirs qui consistent en connaissance, y compris en langue, précédemment inconnue au sujet. Pendant la fugue le sujet perdra tous les souvenirs de leur identité antérieure."
      )
      .addField(
        "**Description**:(8)",
        "Les sujets ont montré des réactions diverses, s'étendant de la presque catatonie aux tentatives d'évasion ou attaquer le personnel de la Fondation. Quand l'état de fugue baisse, les sujets regagneront les souvenirs de leur identités antérieures, mais y conserveront aussi la mémoire de l'identité nouvelle, imprimée et toute la connaissance associée."
      )
      .addField(
        "**Description**:(9)",
        "Les sujets ont dit qu'ils étaient \"comme s'ils ont vécu un entier d'autre vie comme une certaine autre personne\" dans la période entre le contact SCP-1123 et la convalescence de la fugue."
      )
      .addField(
        "Voir la suite sur le wiki",
        "[LA SUITE](http://fondationscp.wikidot.com/scp-1123)",
        true
      );
  ...
  if (message.content === PREFIX + "show 066") {
    const show_066 = new RichEmbed()
      .setColor("RANDOM")
      .setTitle("Voici __SCP-066__:")
      .setImage(
        "http://img0.reactor.cc/pics/post/full/The-SCP-Foundation-%D1%84%D1%8D%D0%BD%D0%B4%D0%BE%D0%BC%D1%8B-SCP-art-%D0%9E%D0%B1%D1%8A%D0%B5%D0%BA%D1%82%D1%8B-SCP-3910782.jpeg"
      );
  ...
  if (message.content === PREFIX + "show 062-fr") {
    const show_062fr = new RichEmbed()
      .setColor("RANDOM")
